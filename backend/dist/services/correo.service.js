...
function obtenerConfiguracionCorreo() {
    ...
    if (!host ||
        ...
        !contrasena ||
        !remitente) {
        throw new Error("La configuración SMTP no está completa");
    }
    return {
        host,
        puerto,
...
async function enviarCorreoRecuperacion({ destinatario, nombreUsuario, enlaceRecuperacion, }) {
    const configuracion = obtenerConfiguracionCorreo();
    ...
    await transportador.sendMail({
        ...
        to: destinatario,
        subject: "Recuperación de contraseña - Re-Usa",
        text: [
            `Hola ${nombreUsuario},`,
            "",
